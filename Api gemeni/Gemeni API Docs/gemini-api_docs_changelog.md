...
- The last available tuning model, Gemini 1.5 Flash 001, has been shutdown. Tuning is no longer supported on any models. See[Fine tuning with the Gemini API](https://ai.google.dev/gemini-api/docs/model-tuning).
