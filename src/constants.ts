...
export const APP_SETTINGS_KEY = "dvach_gemini_app_settings_v2.9_bot_stable"; 
export const SENT_MESSAGES_KEY = "dvach_gemini_sent_messages_v2.9_bot_stable";
export const GEMINI_DVACH_CONVERSATIONS_KEY = "gemini_dvach_conversations_v2.9_bot_stable";
